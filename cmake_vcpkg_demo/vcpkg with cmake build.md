...
download and config environment variable
# vcpkg install:
git repositoriy url:https://github.com/microsoft/vcpkg.git 
build and config ... follow the readme 
...
vcpkg how to use tutorial: https://vcpkg.readthedocs.io/en/latest/examples/installing-and-using-packages/
...
Complete code： 
-
https_request.h  (this file rely by asio and asio rely by openssl)
```
#include <asio.hpp>
...
target_link_libraries(test PRIVATE asio asio::asio)

```

%vcpkg configs% =  C:/Users/sentortu/source/codeFree/vs/vcpkg/scr \
%code path% = C:/sers/entortu/ource/odeFree/s/eptiles
